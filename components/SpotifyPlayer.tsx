    ...
    <div className="flex w-full flex-col gap-3">
      ...
      <div className="grid grid-cols-[auto_1fr_auto] items-center justify-between gap-x-3 gap-y-1">
        ...
        <a
          ...
          className="flex shrink-0 items-center justify-center rounded-full text-neutral-400 outline-none hover:text-neutral-200 focus-visible:ring-2 focus-visible:ring-[#FF4400] focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950"
        >
